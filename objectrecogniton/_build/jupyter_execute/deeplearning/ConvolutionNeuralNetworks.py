...
![Semantic Segmentation Net](https://maucher.home.hdm-stuttgart.de/Pics/channelCube1x1.png)
 ...
 A $1 \times 1$-convolution can be viewed as an Dense-layer opearted over all channels at a specific pixel location. As such it is often applied to reduce the number of channels, while keeping the spatial resolution constant. 
